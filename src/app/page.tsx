...
export default function HomePage() {
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Mobile filter */}
      <div className="border-b border-zinc-200 bg-white px-6 py-3 sm:hidden">
        <CategoryFilter />
      </div>

      {/* Main content */}
      <main className="mx-auto flex w-full max-w-screen-2xl flex-1 gap-5 overflow-hidden p-5">
        ...
        <aside className="flex w-full flex-col gap-3 lg:w-80 xl:w-96">
          ...
          <div className="event-list-scroll flex-1 overflow-y-auto rounded-xl pr-1">
            <EventList />
          </div>
        </aside>
      </main>
